---
title: 'Plug and Play: Enabling Pluggable Attribute Unlearning inRecommender Systems'

---

# Plug and Play: Enabling Pluggable Attribute Unlearning inRecommender Systems
## 方法
- 通过最大化类别编码率 $R^c$ 来破坏用户嵌入中与性别、年龄等属性相关的分布模式，同时使总体编码率R维持在合理值b附近，从而有效删除敏感属性信息，并保留推荐所需的用户兴趣信息。 
...
\left(
\mathbf{I}+
\frac{d}{\operatorname{tr}(\Pi_j)\epsilon^2}
